    					...
    					<tbody>
    						...
    						<tr>
    							...
    							<td>
	    							<input type="text" id="uEmail_01"
    									maxlength="20" size="7" value="${fn:split(Obj.uEmail,'@')[0]}">
    								<span>@</span>
    								<input type="text" id="uEmail_02"
    									maxlength="40" size="10" value="${fn:split(Obj.uEmail,'@')[1]}">
    						...
    						<tr>
    							...
    							<td>
    								...
    								maxlength="6" size="8" value="${Obj.uBirthday}">&nbsp;&nbsp;&nbsp;&nbsp;
    								<span>ex. 830815</span>
    							</td>
    							<td>&nbsp;</td>
    						</tr>
    						<tr>
    							...
    							<td>    								
    								...
    								maxlength="7" size="7" value= "${Obj.uZipcode}" readonly>
    						...
    						<tr>
    							...
    							<td>    								
    								...
    								maxlength="100" size="50" value= "${Obj.uAddr }">
    							</td>
    							<td>&nbsp;</td>
    						</tr>
    						<tr>
    							...
    							<td>    		
    								...
    								<label> 여행
    									 ...
    									 <c:if test="${fn:substring(Obj.uHobby,1,2) eq'1'}">
				                                  checked="checked"
				                              </c:if>
    									 >
    								</label>						
    								<label> 게임
    									 ...
    									 <c:if test="${fn:substring(Obj.uHobby,2,3) eq'1'}">
				                                  checked="checked"
				                              </c:if>
    									 >
    								</label>						
    								<label> 영화
    									 ...
    									 <c:if test="${fn:substring(Obj.uHobby,3,4) eq'1'}">
				                                  checked="checked"
				                              </c:if>
    									 >
    								</label>						
    								<label> 운동
    									 ...
    									 <c:if test="${fn:substring(Obj.uHobby,4,5) eq'1'}">
				                                  checked="checked"
				                              </c:if>
    									 >
    								</label>
    						...
    						<tr>
    							<td colspan="3">
    								<a href="javascript:history.back();">
										<button type="button" class="frmBtn" id="backBtn">뒤 로</button>		
									</a>
